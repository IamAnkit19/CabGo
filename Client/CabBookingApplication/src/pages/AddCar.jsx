...
const AddCar = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await API.post('/cars/add', formDataToSend, {
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="container mx-auto p-8 max-w-xl">
                ...
                <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl shadow-md space-y-4">
                    ...
                    <div>
                        <label className="block text-sm font-semibold mb-1">Car Type (e.g. Sedan, SUV)</label>
                        <input
                            type="text"
                            name="cartype"
                    ...
                    <div>
                        <label className="block text-sm font-semibold mb-1">Car Image (optional, jpeg/png/webp)</label>
                        <input
                            type="file"
